...
public class DrawableBSTree<E extends Comparable<? super E>> extends JPanel{
/**
 ...
 */
	...
	private java.util.LinkedList<DrawableBTNode<E>> listing; // used for its Iterator.
 ...
 */
 	public DrawableBSTree( BinarySearchTree<E> tree, Dimension canvasSize ) {
 	  	super();
 ...
 * @param tree The BinaryTree object that is to be drawn.
 */
 	public DrawableBSTree (BinarySearchTree<E> tree ) {
 	  	super();
 	  	setTree( tree );
 ...
 */
	...
	public void setTree( BinarySearchTree<E> tree, Dimension canvasSize ) {
	  setTree( tree );
	  this.setSize( canvasSize );
	}

	public void setTree( BinarySearchTree<E> tree ) {
	  this.tree = tree;
	  ...
	  listing = new java.util.LinkedList<DrawableBTNode<E>>();
 ...
 */
	private DrawableBTNode<E> buildTree( TreeNode<E> top, int level ) {
		...
		return new DrawableBTNode<E>( top.getData(),
